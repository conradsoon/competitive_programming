...
struct intAddMonoid
{
    ...
    intAddMonoid(ll x) : val(x) //should initialise to unit for monoid, if no convenient unit exists, should modify plus function and add a boolean to indicate isunit.
    {
    }
    //With reference from:
